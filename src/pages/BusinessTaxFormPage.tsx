    ...
    <div className="container my-12 max-w-4xl mx-auto px-4">
      <div className="mb-6">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">New Business Client Form</h1>
          ...
          <div className="p-6">
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span><span className="text-purple-600 font-medium">New Business Client?</span> Kindly Nominate us as your Tax & GST agent by following the steps via this link. It is an ATO requirement effective from 13/11/2023.</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="h-5 w-5 text-purple-600 mt-1 mr-3 flex-shrink-0" />
                <span>The following guide helps you complete this form correctly & efficiently. Please <strong className="text-purple-600">Do not rush/submit insufficient information</strong>. You can <strong className="text-purple-600">SAVE</strong> and <strong className="text-purple-600">RESUME</strong> the form anytime.</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="h-5 w-5 text-purple-600 mt-1 mr-3 flex-shrink-0" />
                <span>Complete this form for each entity per financial year, if you need us to act for multiple entities.</span>
              </li>
              <li className="flex items-start">
                <CheckCircle2 className="h-5 w-5 text-purple-600 mt-1 mr-3 flex-shrink-0" />
                <span>Answer all applicable questions by selecting "Yes" or "No" in the dropbox, provide details & upload supporting documents.</span>
              </li>
              <li className="flex items-start">
                <AlertCircle className="h-5 w-5 text-purple-600 mt-1 mr-3 flex-shrink-0" />
                <span>This form is to be submitted in conjunction with our Engagement Letter.</span>
              </li>
            </ul>

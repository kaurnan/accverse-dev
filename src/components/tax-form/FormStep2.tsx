...
const FormStep2: React.FC<FormStep2Props> = ({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 animate-fade-in">
      <div className="mb-4">
        <h2 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-purple-700">Part 2: Tax Residency & Offsets</h2>
        <p className="text-gray-600 mt-1">Provide details of Medicare, Private Health Insurance, Spouse, Dependents, if applicable.</p>
      </div>
      
      <div className="space-y-6">
        <div className="form-group">
          <div className="flex items-center mb-2">
            <Label className="block text-gray-700 font-medium">Australian Citizen / Permanent Resident for Immigration Purposes? <span className="text-red-500">*</span></Label>
          ...
          >
            <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-50">
              ...
              <Label htmlFor="yesDuringYear" className="cursor-pointer">YES: in Australia during the financial year</Label>
            </div>
            <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-50">
              <RadioGroupItem value="yesReturned" id="yesReturned" />
              <Label htmlFor="yesReturned" className="cursor-pointer">YES: returned during the financial year from working abroad</Label>
            </div>
            <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-50">
              <RadioGroupItem value="noArrived" id="noArrived" />
              <Label htmlFor="noArrived" className="cursor-pointer">NO: arrived in Australia during the financial year</Label>
            </div>
          </RadioGroup>
        ...
        <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
          ...
          <div className="space-y-5">
            <div className="form-group">
              <div className="flex items-center mb-2">
                <Label className="block text-gray-700 font-medium">Have a Spouse during the FY? <span className="text-red-500">*</span></Label>
                <div className="group relative ml-2 inline-block">
              ...
              >
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  ...
                  <Label htmlFor="spouseYes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  <RadioGroupItem value="no" id="spouseNo" />
                  <Label htmlFor="spouseNo" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
            ...
            <div className="form-group">
              <div className="flex items-center mb-2">
                <Label className="block text-gray-700 font-medium">Did you have any Dependents during the Financial Year? <span className="text-red-500">*</span></Label>
                <div className="group relative ml-2 inline-block">
              ...
              >
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  ...
                  <Label htmlFor="dependentsYes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  <RadioGroupItem value="no" id="dependentsNo" />
                  <Label htmlFor="dependentsNo" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
            ...
            <div className="form-group">
              <div className="flex items-center mb-2">
                <Label className="block text-gray-700 font-medium">Have Medicare card? <span className="text-red-500">*</span></Label>
                <div className="group relative ml-2 inline-block">
              ...
              >
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  ...
                  <Label htmlFor="medicareYes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  <RadioGroupItem value="no" id="medicareNo" />
                  <Label htmlFor="medicareNo" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
            ...
            <div className="form-group">
              <div className="flex items-center mb-2">
                <Label className="block text-gray-700 font-medium">Have Private Health Insurance? <span className="text-red-500">*</span></Label>
                <div className="group relative ml-2 inline-block">
              ...
              >
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  ...
                  <Label htmlFor="privateHealthYes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  <RadioGroupItem value="no" id="privateHealthNo" />
                  <Label htmlFor="privateHealthNo" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
              ...
              {formData.privateHealth === 'yes' && (
                <div className="mt-3 ml-7">
                  <p className="text-sm text-gray-600 mb-2">Please upload your Private Health Insurance Statement. This statement can be obtained via your Insurer's website, phone, or email.</p>
                  <FileUpload 
            ...
            <div className="form-group">
              <div className="flex items-center mb-2">
                <Label className="block text-gray-700 font-medium">HECS/HELP Debt? <span className="text-red-500">*</span></Label>
                <div className="group relative ml-2 inline-block">
              ...
              >
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  ...
                  <Label htmlFor="hecsDebtYes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100">
                  <RadioGroupItem value="no" id="hecsDebtNo" />
                  <Label htmlFor="hecsDebtNo" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
